...
export class HelpWingow {
    render() {
        ...
        this.rules = ['accepted figures: line, rectangle, triangle, circle, ellipse',
            ...
            'to draw a line you must supply two coordinates (starting and ending points), example: line -p [0, 0] [50, 50]',
            'to draw a rectangle you must supply two coordinates (starting and ending points of diagonal), example: rectangle -p [0, 0] [50, 50]',
            'to draw a triangle you must supply three coordinates (points of triangle), example: triangle -p [50, 300] [50, 100] [300, 100]',
            'to draw a circle you must supply one coordinate (center) and a radius, example: circle -p [75, 75] -r 25',
            'to draw an ellipse you must supply one coordinate (center) and two radiuses, example: ellipse -p [75, 75] -r1 50 -r2 25',
